# 🧠 CS50’s Introduction to Artificial Intelligence with Python — Project Portfolio

This repository contains my implementations of projects from Harvard’s
**CS50’s Introduction to Artificial Intelligence with Python**.

The course explores the **core algorithms and principles behind modern AI**, including search, knowledge representation, probabilistic reasoning, optimization, machine learning, and natural language processing ([edX][1]).
