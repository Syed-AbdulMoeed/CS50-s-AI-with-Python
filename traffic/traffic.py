...
def load_data(data_dir):
    ...
    # reading from a dir that contains other dirs
    for image_type in images_dir:

        image_type_path = os.path.join(path, image_type)
        int_label = int(image_type)
